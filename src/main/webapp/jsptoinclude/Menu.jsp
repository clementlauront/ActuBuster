            ...
            <nav>
                ...
                <ul>
                    ...
                    <ul>
                        ...
                        <li><a href="/ActuBuster/AdministrationDuSite">G�rer les membres et les articles</a></li>
                        <li><a href="/ActuBuster/AfficherMessages">G�rer les messages</a></li>
...
<script>
	...
	if (pseudo ==""){
		//Mettre le texte ci-dessous a l'emplacement HTML indiqu�e par l'Id
