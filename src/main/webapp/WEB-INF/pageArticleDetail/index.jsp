    ...
    <main>
        ...
        <section id="article">
            ...
            <article class="article">
                ...
                <div class="head_box">
                    <p>
                        (Chapeau de l'article) Qui Q pauci ore et profecto incidere solebat familiares Pompeio Q solebat
                        saepe amantissime in in saepe admodum multa querella erat hominum in amantissime amantissime tum
                        incidere hemicyclio memini P consul vel admodum una et odio profecto hemicyclio in vixerat.
                    </p>
                </div>

                <div class="contenu">

                    <p>(Contenu de l'article) Et hanc quidem praeter oppida multa duae civitates exornant Seleucia opus
                        Seleuci regis, et Claudiopolis quam deduxit coloniam Claudius Caesar. Isaura enim antehac nimium
                        potens, olim subversa ut rebellatrix interneciva aegre vestigia claritudinis pristinae monstrat
                        admodum pauca.
                        Cum autem commodis intervallata temporibus convivia longa et noxia coeperint apparari vel
                        distributio sollemnium sportularum, anxia deliberatione tractatur an exceptis his quibus
                        vicissitudo debetur, peregrinum invitari conveniet, et si digesto plene consilio id placuerit
                        fieri, is adhibetur qui pro domibus excubat aurigarum aut artem tesserariam profitetur aut
                        secretiora quaedam se nosse confingit.
                    ...
                    <div class="signature">
                        ...
                        <p><button><a href="#">Ajouter</a><button><a href="#">Enlever</a></button></button><button><a href="#">Supprimer</a></button><a
                                href="#">Retour</a></p>
